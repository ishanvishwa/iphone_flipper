...
# Database setup
# Note: we resolve the parent of the *original* scraper.py location (iphone_flipper/) 
# to keep DB location consistent.
# The new file is in iphone_flipper/core/scraper/config.py
# So parents: config.py -> scraper -> core -> iphone_flipper (root package)
